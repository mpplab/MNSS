...
class ConsoleView(PyCutExt, ConsoleCmd):
    ...
    def __init__(self, parent):
        ...
        self.intro = "MNSS management console.\nRunning MNSS version {} on {} ({}-bit) with Python {} Qt {}.\n" \
                     "Copyright (c) 2006-{} MNSS Technologies.\n" \
                     "Use Help -> MNSS Doctor to detect common issues." \
