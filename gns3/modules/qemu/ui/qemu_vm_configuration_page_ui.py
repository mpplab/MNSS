...
class Ui_QemuVMConfigPageWidget(object):
    ...
    def retranslateUi(self, QemuVMConfigPageWidget):
        ...
        QemuVMConfigPageWidget.setWindowTitle(_translate("QemuVMConfigPageWidget", "QEMU VM配置"))
        self.uiRamLabel.setText(_translate("QemuVMConfigPageWidget", "RAM:"))
        self.uiSymbolToolButton.setText(_translate("QemuVMConfigPageWidget", "  浏览  "))
        self.uiRamSpinBox.setSuffix(_translate("QemuVMConfigPageWidget", " MB"))
        self.uiSymbolLabel.setText(_translate("QemuVMConfigPageWidget", "图标："))
        ...
        self.uiConsoleTypeLabel.setText(_translate("QemuVMConfigPageWidget", "连接类型："))
        self.uiBootPriorityLabel.setText(_translate("QemuVMConfigPageWidget", "优先启动："))
        self.uiQemuListLabel.setText(_translate("QemuVMConfigPageWidget", "QEMU的二进制："))
        self.uiConsolePortLabel.setText(_translate("QemuVMConfigPageWidget", "端口号："))
        self.uiCategoryLabel.setText(_translate("QemuVMConfigPageWidget", "类别："))
        self.uiNameLabel.setText(_translate("QemuVMConfigPageWidget", "名称："))
        self.uiCPULabel.setText(_translate("QemuVMConfigPageWidget", "vCPUs:"))
        self.uiDefaultNameFormatLabel.setText(_translate("QemuVMConfigPageWidget", "默认名称格式："))
        self.uiQemutabWidget.setTabText(self.uiQemutabWidget.indexOf(self.uiGeneralSettingsTab), _translate("QemuVMConfigPageWidget", "常规设置"))
        self.uiHdaGroupBox.setTitle(_translate("QemuVMConfigPageWidget", "HDA (Primary Master)"))
        self.uiHdaDiskImageLabel.setText(_translate("QemuVMConfigPageWidget", "磁盘镜像："))
        self.uiHdaDiskImageToolButton.setText(_translate("QemuVMConfigPageWidget", "  浏览  "))
        self.uiHdaDiskImageCreateToolButton.setText(_translate("QemuVMConfigPageWidget", "  创建  "))
        self.uiHdaDiskInterfaceLabel.setText(_translate("QemuVMConfigPageWidget", "磁盘接口："))
        self.uiHdbgroupBox.setTitle(_translate("QemuVMConfigPageWidget", "HDB (Primary Slave)"))
        self.uiHdbDiskImageLabel.setText(_translate("QemuVMConfigPageWidget", "磁盘镜像："))
        self.uiHdbDiskImageToolButton.setText(_translate("QemuVMConfigPageWidget", "  浏览  "))
        self.uiHdbDiskImageCreateToolButton.setText(_translate("QemuVMConfigPageWidget", "  创建  "))
        self.uiHdbDiskInterfaceLabel.setText(_translate("QemuVMConfigPageWidget", "磁盘接口："))
        self.uiHdcGroupBox.setTitle(_translate("QemuVMConfigPageWidget", "HDC (Secondary Master)"))
        self.uiHdcDiskImageLabel.setText(_translate("QemuVMConfigPageWidget", "磁盘镜像："))
        self.uiHdcDiskImageToolButton.setText(_translate("QemuVMConfigPageWidget", "  浏览  "))
        self.uiHdcDiskImageCreateToolButton.setText(_translate("QemuVMConfigPageWidget", "  创建  "))
        self.uiHdcDiskInterfaceLabel.setText(_translate("QemuVMConfigPageWidget", "磁盘接口："))
        self.uiHddGroupBox.setTitle(_translate("QemuVMConfigPageWidget", "HDD (Secondary Slave)"))
        self.uiHddDiskImageLabel.setText(_translate("QemuVMConfigPageWidget", "磁盘镜像："))
        self.uiHddDiskImageToolButton.setText(_translate("QemuVMConfigPageWidget", "  浏览  "))
        self.uiHddDiskImageCreateToolButton.setText(_translate("QemuVMConfigPageWidget", "  创建  "))
        self.uiHddDiskInterfaceLabel.setText(_translate("QemuVMConfigPageWidget", "磁盘接口："))
        ...
        self.uiCdromImageLabel.setText(_translate("QemuVMConfigPageWidget", "镜像："))
        self.uiCdromImageToolButton.setText(_translate("QemuVMConfigPageWidget", "  浏览  "))
        self.uiQemutabWidget.setTabText(self.uiQemutabWidget.indexOf(self.uiCdromTab), _translate("QemuVMConfigPageWidget", "CD/DVD"))
        self.uiLegacyNetworkingCheckBox.setText(_translate("QemuVMConfigPageWidget", "使用遗留网络模式"))
        self.uiPortSegmentSizeLabel.setText(_translate("QemuVMConfigPageWidget", "段的大小："))
        self.uiAdapterTypesLabel.setText(_translate("QemuVMConfigPageWidget", "类别："))
        self.uiAdaptersLabel.setText(_translate("QemuVMConfigPageWidget", "适配器："))
        self.uiMacAddrLabel.setText(_translate("QemuVMConfigPageWidget", "MAC基础："))
        ...
        self.uiPortNameFormatLabel.setText(_translate("QemuVMConfigPageWidget", "名称格式："))
        self.uiFirstPortNameLabel.setText(_translate("QemuVMConfigPageWidget", "第一个端口名："))
        self.uiQemutabWidget.setTabText(self.uiQemutabWidget.indexOf(self.uiNetworkTab), _translate("QemuVMConfigPageWidget", "网络"))
        self.uiLinuxBootGroupBox.setTitle(_translate("QemuVMConfigPageWidget", "Linux启动特异性参数"))
        self.uiKernelImageLabel.setText(_translate("QemuVMConfigPageWidget", "内核镜像："))
        self.uiInitrdLabel.setText(_translate("QemuVMConfigPageWidget", "初始化内存盘（initrd）："))
        self.uiKernelImageToolButton.setText(_translate("QemuVMConfigPageWidget", "  浏览  "))
        self.uiInitrdToolButton.setText(_translate("QemuVMConfigPageWidget", "  浏览  "))
        self.uiKernelCommandLineLabel.setText(_translate("QemuVMConfigPageWidget", "内核命令行："))
        self.uiOptimizationGroupBox.setTitle(_translate("QemuVMConfigPageWidget", "优化"))
        self.uiActivateCPUThrottlingCheckBox.setText(_translate("QemuVMConfigPageWidget", "激活CPU节流"))
        self.uiCPUThrottlingLabel.setText(_translate("QemuVMConfigPageWidget", "CPU允许百分比："))
        self.uiCPUThrottlingSpinBox.setSuffix(_translate("QemuVMConfigPageWidget", " %"))
        self.uiProcessPriorityLabel.setText(_translate("QemuVMConfigPageWidget", "进程的优先级："))
        ...
        self.groupBox.setTitle(_translate("QemuVMConfigPageWidget", "额外的设置"))
        self.uiQemuOptionsLabel.setText(_translate("QemuVMConfigPageWidget", "选项："))
        self.uiBaseVMCheckBox.setText(_translate("QemuVMConfigPageWidget", "作为链接的基础VM使用"))
        self.uiACPIShutdownCheckBox.setText(_translate("QemuVMConfigPageWidget", "启用关闭ACPI（实验）"))
        self.uiQemutabWidget.setTabText(self.uiQemutabWidget.indexOf(self.uiAdvancedSettingsTab), _translate("QemuVMConfigPageWidget", "优化配置"))
