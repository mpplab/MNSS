...
class Ui_iosRouterConfigPageWidget(object):
    ...
    def retranslateUi(self, iosRouterConfigPageWidget):
        ...
        iosRouterConfigPageWidget.setWindowTitle(_translate("iosRouterConfigPageWidget", "Dynamips IOS 路由器配置"))
        self.uiPrivateConfigToolButton.setText(_translate("iosRouterConfigPageWidget", "  浏览  "))
        self.uiAuxPortLabel.setText(_translate("iosRouterConfigPageWidget", "Aux端口:"))
        self.uiSymbolLabel.setText(_translate("iosRouterConfigPageWidget", "图标："))
        self.uiConsolePortLabel.setText(_translate("iosRouterConfigPageWidget", "控制端口："))
        self.uiStartupConfigToolButton.setText(_translate("iosRouterConfigPageWidget", "  浏览  "))
        self.uiPlatformLabel.setText(_translate("iosRouterConfigPageWidget", "平台"))
        self.uiIOSImageToolButton.setText(_translate("iosRouterConfigPageWidget", "  浏览  "))
        self.uiNameLabel.setText(_translate("iosRouterConfigPageWidget", "名称："))
        self.uiPrivateConfigLabel.setText(_translate("iosRouterConfigPageWidget", "初始私有配置："))
        self.uiStartupConfigLabel.setText(_translate("iosRouterConfigPageWidget", "初始启动配置："))
        self.uiCategoryLabel.setText(_translate("iosRouterConfigPageWidget", "种类："))
        self.uiSymbolToolButton.setText(_translate("iosRouterConfigPageWidget", "  浏览  "))
        self.uiChassisLabel.setText(_translate("iosRouterConfigPageWidget", "类别："))
        self.uiMidplaneLabel.setText(_translate("iosRouterConfigPageWidget", "Midplane:"))
        self.uiIOSImageLabel.setText(_translate("iosRouterConfigPageWidget", "IOS镜像路径:"))
        self.uiNPELabel.setText(_translate("iosRouterConfigPageWidget", "NPE:"))
        self.uiDefaultNameFormatLabel.setText(_translate("iosRouterConfigPageWidget", "默认名称格式："))
        self.uiTabWidget.setTabText(self.uiTabWidget.indexOf(self.uiGeneralPageWidget), _translate("iosRouterConfigPageWidget", "常规"))
        self.uiRamLabel.setText(_translate("iosRouterConfigPageWidget", "RAM大小:"))
        self.uiRamSpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " MiB"))
        self.uiNvramLabel.setText(_translate("iosRouterConfigPageWidget", "NVRAM大小:"))
        self.uiNvramSpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " KiB"))
        self.uiIomemLabel.setText(_translate("iosRouterConfigPageWidget", "I/O内存:"))
        self.uiIomemSpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " %"))
        self.uiDisk0Label.setText(_translate("iosRouterConfigPageWidget", "PCMCIA 磁盘0:"))
        self.uiDisk0SpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " MiB"))
        self.uiDisk1Label.setText(_translate("iosRouterConfigPageWidget", "PCMCIA 磁盘1:"))
        self.uiDisk1SpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " MiB"))
        self.uiAutoDeleteCheckBox.setText(_translate("iosRouterConfigPageWidget", "自动删除NVRAM和磁盘文件"))
        self.uiTabWidget.setTabText(self.uiTabWidget.indexOf(self.uiMemoriesPageWidget), _translate("iosRouterConfigPageWidget", "存储器和磁盘"))
        ...
        self.uiTabWidget.setTabText(self.uiTabWidget.indexOf(self.uiSlotsPageWidget), _translate("iosRouterConfigPageWidget", "槽"))
        self.uiSystemGroupBox.setTitle(_translate("iosRouterConfigPageWidget", "系统"))
        ...
        self.uiOptimizationsGroupBox.setTitle(_translate("iosRouterConfigPageWidget", "优化选项"))
        ...
        self.uiSparseMemoryCheckBox.setText(_translate("iosRouterConfigPageWidget", "启用sparse memory支持"))
        ...
        self.uiMmapCheckBox.setText(_translate("iosRouterConfigPageWidget", "启用mmap支持"))
        self.uiIdlesleepSpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " ms"))
        self.uiTabWidget.setTabText(self.uiTabWidget.indexOf(self.uiAdvancedPageWidget), _translate("iosRouterConfigPageWidget", "优化"))
        self.uiPowerSuppliesGroupBox.setTitle(_translate("iosRouterConfigPageWidget", "电源供应器"))
        self.uiPowerSupply2Label.setText(_translate("iosRouterConfigPageWidget", "电源供应 2："))
        ...
        self.uiPowerSupply1Label.setText(_translate("iosRouterConfigPageWidget", "电源供应 1："))
        ...
        self.uiSensorsGroupBox.setTitle(_translate("iosRouterConfigPageWidget", "温度传感器"))
        self.uiSensor1Label.setText(_translate("iosRouterConfigPageWidget", "I/O控制器入口："))
        self.uiSensor1SpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " C"))
        self.uiSensor2Label.setText(_translate("iosRouterConfigPageWidget", "I/O控制器出口："))
        self.uiSensor2SpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " C"))
        self.uiSensor3Label.setText(_translate("iosRouterConfigPageWidget", "NPE入口："))
        self.uiSensor3SpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " C"))
        self.uiSensor4Label.setText(_translate("iosRouterConfigPageWidget", "NPE出口："))
        self.uiSensor4SpinBox.setSuffix(_translate("iosRouterConfigPageWidget", " C"))
        self.uiTabWidget.setTabText(self.uiTabWidget.indexOf(self.uiEnvironmentPageWidget), _translate("iosRouterConfigPageWidget", "环境"))
