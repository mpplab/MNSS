...
class Ui_cloudConfigPageWidget(object):
    ...
    def retranslateUi(self, cloudConfigPageWidget):
        ...
        cloudConfigPageWidget.setWindowTitle(_translate("cloudConfigPageWidget", "Cloud设置"))
        self.uiGenericEthernetGroupBox.setTitle(_translate("cloudConfigPageWidget", "一般的以太网NIO"))
        self.uiAddGenericEthernetPushButton.setText(_translate("cloudConfigPageWidget", "添加"))
        self.uiDeleteGenericEthernetPushButton.setText(_translate("cloudConfigPageWidget", "删除"))
        self.uiLinuxEthernetGroupBox.setTitle(_translate("cloudConfigPageWidget", "Linux以太网NIO(仅限Linux)"))
        self.uiAddLinuxEthernetPushButton.setText(_translate("cloudConfigPageWidget", "添加"))
        self.uiDeleteLinuxEthernetPushButton.setText(_translate("cloudConfigPageWidget", "删除"))
        ...
        self.uiNIONATSettingsGroupBox.setTitle(_translate("cloudConfigPageWidget", "设置"))
        self.uiNIONATIdentifierLabel.setText(_translate("cloudConfigPageWidget", "本地标识符："))
        self.uiNIONATListGroupBox.setTitle(_translate("cloudConfigPageWidget", "NIOs"))
        self.uiAddNIONATPushButton.setText(_translate("cloudConfigPageWidget", "添加"))
        self.uiDeleteNIONATPushButton.setText(_translate("cloudConfigPageWidget", "删除"))
        self.uiNIOsTabWidget.setTabText(self.uiNIOsTabWidget.indexOf(self.NIONATTab), _translate("cloudConfigPageWidget", "NAT"))
        self.uiNIOUDPSettingsGroupBox.setTitle(_translate("cloudConfigPageWidget", "设置"))
        self.uiLocalPortLabel.setText(_translate("cloudConfigPageWidget", "本地端口："))
        self.uiRemoteHostLabel.setText(_translate("cloudConfigPageWidget", "云端主机："))
        self.uiRemoteHostLineEdit.setText(_translate("cloudConfigPageWidget", "127.0.0.1"))
        self.uiRemotePortLabel.setText(_translate("cloudConfigPageWidget", "云端端口："))
        self.uiNIOUDPListGroupBox.setTitle(_translate("cloudConfigPageWidget", "NIOs"))
        self.uiAddNIOUDPPushButton.setText(_translate("cloudConfigPageWidget", "添加"))
        self.uiDeleteNIOUDPPushButton.setText(_translate("cloudConfigPageWidget", "删除"))
        self.uiNIOsTabWidget.setTabText(self.uiNIOsTabWidget.indexOf(self.NIOUDPTab), _translate("cloudConfigPageWidget", "UDP"))
        self.uiNIOTAPGroupBox.setTitle(_translate("cloudConfigPageWidget", "TAP接口"))
        self.uiAddNIOTAPPushButton.setText(_translate("cloudConfigPageWidget", "添加"))
        self.uiDeleteNIOTAPPushButton.setText(_translate("cloudConfigPageWidget", "删除"))
        self.uiNIOsTabWidget.setTabText(self.uiNIOsTabWidget.indexOf(self.NIOTAPTab), _translate("cloudConfigPageWidget", "TAP"))
        self.uiNIOUNIXSettingsGroupBox.setTitle(_translate("cloudConfigPageWidget", "设置"))
        self.uiLocalFileLabel.setText(_translate("cloudConfigPageWidget", "本地文件"))
        self.uiRemoteFileLabel.setText(_translate("cloudConfigPageWidget", "云端文件"))
        self.uiNIOUNIXListGroupBox.setTitle(_translate("cloudConfigPageWidget", "NIOs"))
        self.uiAddNIOUNIXPushButton.setText(_translate("cloudConfigPageWidget", "添加"))
        self.uiDeleteNIOUNIXPushButton.setText(_translate("cloudConfigPageWidget", "删除"))
        self.uiNIOsTabWidget.setTabText(self.uiNIOsTabWidget.indexOf(self.NIOUnixTab), _translate("cloudConfigPageWidget", "UNIX"))
        self.uiNIOVDESettingsGroupBox.setTitle(_translate("cloudConfigPageWidget", "设置"))
        self.uiVDEControlFileLabel.setText(_translate("cloudConfigPageWidget", "控制文件"))
        self.uiVDELocalFileLabel.setText(_translate("cloudConfigPageWidget", "本地文件"))
        self.uiNIOVDEListGroupBox.setTitle(_translate("cloudConfigPageWidget", "NIOs"))
        self.uiAddNIOVDEPushButton.setText(_translate("cloudConfigPageWidget", "添加"))
        self.uiDeleteNIOVDEPushButton.setText(_translate("cloudConfigPageWidget", "删除"))
        self.uiNIOsTabWidget.setTabText(self.uiNIOsTabWidget.indexOf(self.NIOVDETab), _translate("cloudConfigPageWidget", "VDE"))
        self.uiNIONullSettingsGroupBox.setTitle(_translate("cloudConfigPageWidget", "设置"))
        self.uiNIONullIdentifierLabel.setText(_translate("cloudConfigPageWidget", "本地标识符："))
        self.uiNIONullListGroupBox.setTitle(_translate("cloudConfigPageWidget", "NIOs"))
        self.uiAddNIONullPushButton.setText(_translate("cloudConfigPageWidget", "添加"))
        self.uiDeleteNIONullPushButton.setText(_translate("cloudConfigPageWidget", "删除"))
        self.uiNIOsTabWidget.setTabText(self.uiNIOsTabWidget.indexOf(self.NIONullTab), _translate("cloudConfigPageWidget", "NULL"))
        self.uiNameLabel.setText(_translate("cloudConfigPageWidget", "名称："))
