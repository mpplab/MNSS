...
class Ui_ServerPreferencesPageWidget(object):
    def setupUi(self, ServerPreferencesPageWidget):
        ...
        self.uiRemoteServersTreeWidget.headerItem().setText(0, "协议")
        self.uiRemoteServersTreeWidget.headerItem().setText(1, "主机地址")
        self.uiRemoteServersTreeWidget.headerItem().setText(2, "端口")
    ...
    def retranslateUi(self, ServerPreferencesPageWidget):
        ...
        ServerPreferencesPageWidget.setWindowTitle(_translate("ServerPreferencesPageWidget", "服务器设置"))
        self.uiGeneralSettingsGroupBox.setTitle(_translate("ServerPreferencesPageWidget", "常规设置"))
        self.uiLocalServerPathLabel.setText(_translate("ServerPreferencesPageWidget", "Server路径："))
        self.uiLocalServerToolButton.setText(_translate("ServerPreferencesPageWidget", "  浏览  "))
        self.uiUbridgePathLabel.setText(_translate("ServerPreferencesPageWidget", "Ubridge路径："))
        self.uiUbridgeToolButton.setText(_translate("ServerPreferencesPageWidget", "  浏览  "))
        self.uiLocalServerHostLabel.setText(_translate("ServerPreferencesPageWidget", "主机绑定："))
        self.uiLocalServerPortLabel.setText(_translate("ServerPreferencesPageWidget", "端口号："))
        self.uiConsoleConnectionsToAnyIPCheckBox.setText(_translate("ServerPreferencesPageWidget", "允许控制台连接到任何本地IP地址"))
        self.uiLocalServerAuthCheckBox.setText(_translate("ServerPreferencesPageWidget", "服务器密码保护（推荐）"))
        self.uiLocalServerAutoStartCheckBox.setText(_translate("ServerPreferencesPageWidget", "允许本地服务器"))
        self.uiConsolePortRangeGroupBox.setTitle(_translate("ServerPreferencesPageWidget", "控制台端口范围（5900 = > 6000共享VNC）"))
        self.uiConsolePortRangeLabel.setText(_translate("ServerPreferencesPageWidget", "to"))
        self.uiUDPPortRangeGroupBox.setTitle(_translate("ServerPreferencesPageWidget", "隧道端口范围"))
        self.uiUDPPortRangeLabel.setText(_translate("ServerPreferencesPageWidget", "to"))
        self.uiServerPreferenceTabWidget.setTabText(self.uiServerPreferenceTabWidget.indexOf(self.uiLocalTabWidget), _translate("ServerPreferencesPageWidget", "本地服务器"))
        self.uiEnableVMCheckBox.setText(_translate("ServerPreferencesPageWidget", "允许GNS3 VM"))
        self.uiVirtualizationGroupBox.setTitle(_translate("ServerPreferencesPageWidget", "  Virtualization software 虚拟化软体"))
        ...
        self.uiLocalGNS3VMSettingsGroupBox.setTitle(_translate("ServerPreferencesPageWidget", "本地GNS3 VM配置"))
        self.uiVMNameLabel.setText(_translate("ServerPreferencesPageWidget", "VM名称:"))
        self.uiRefreshPushButton.setText(_translate("ServerPreferencesPageWidget", "重置"))
        self.uiHeadlessCheckBox.setText(_translate("ServerPreferencesPageWidget", "以headless模式开启GNS3 VM"))
        self.uiShutdownCheckBox.setText(_translate("ServerPreferencesPageWidget", "ACPI关机时关闭GNS3 VM"))
        self.uiAdjustLocalServerIPCheckBox.setText(_translate("ServerPreferencesPageWidget", "将本地服务器IP调整为同一个子网。"))
        self.uiRemoteGNS3VMSettingsGroupBox.setTitle(_translate("ServerPreferencesPageWidget", "云端GNS3 VM"))
        self.label.setText(_translate("ServerPreferencesPageWidget", "服务器："))
        self.uiAddServerPushButton.setText(_translate("ServerPreferencesPageWidget", "添加服务器"))
        self.uiServerPreferenceTabWidget.setTabText(self.uiServerPreferenceTabWidget.indexOf(self.uiGNS3VMTabWidget), _translate("ServerPreferencesPageWidget", "GNS3 VM 服务器"))
        self.uiRemoteServersTreeWidget.headerItem().setText(3, _translate("ServerPreferencesPageWidget", "用户"))
        self.uiAddRemoteServerPushButton.setText(_translate("ServerPreferencesPageWidget", "添加"))
        self.uiDeleteRemoteServerPushButton.setText(_translate("ServerPreferencesPageWidget", "删除"))
        self.uiServerPreferenceTabWidget.setTabText(self.uiServerPreferenceTabWidget.indexOf(self.uiRemoteTabWidget), _translate("ServerPreferencesPageWidget", "云端服务器"))
        self.uiRestoreDefaultsPushButton.setText(_translate("ServerPreferencesPageWidget", "重置"))
