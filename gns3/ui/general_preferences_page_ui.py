...
class Ui_GeneralPreferencesPageWidget(object):
    def setupUi(self, GeneralPreferencesPageWidget):
        ...
        GeneralPreferencesPageWidget.resize(586, 568)
    ...
    def retranslateUi(self, GeneralPreferencesPageWidget):
        ...
        GeneralPreferencesPageWidget.setWindowTitle(_translate("GeneralPreferencesPageWidget", "常规配置"))
        self.uiLocalPathsGroupBox.setTitle(_translate("GeneralPreferencesPageWidget", "本地路径"))
        self.uiProjectsPathLabel.setText(_translate("GeneralPreferencesPageWidget", "我的工程："))
        ...
        self.uiProjectsPathToolButton.setText(_translate("GeneralPreferencesPageWidget", "  浏览  "))
        self.uiImagesPathLabel.setText(_translate("GeneralPreferencesPageWidget", "我的镜像："))
        ...
        self.uiImagesPathToolButton.setText(_translate("GeneralPreferencesPageWidget", "  浏览  "))
        self.label.setText(_translate("GeneralPreferencesPageWidget", "我的标记："))
        self.uiSymbolsPathToolButton.setText(_translate("GeneralPreferencesPageWidget", "  浏览  "))
        self.uiConfigsPathLabel.setText(_translate("GeneralPreferencesPageWidget", "我的配置："))
        ...
        self.uiConfigsPathToolButton.setText(_translate("GeneralPreferencesPageWidget", "  浏览  "))
        self.uiConfigurationFileGroupBox.setTitle(_translate("GeneralPreferencesPageWidget", "配置文件"))
        self.uiImportConfigurationFilePushButton.setText(_translate("GeneralPreferencesPageWidget", "&导入"))
        self.uiExportConfigurationFilePushButton.setText(_translate("GeneralPreferencesPageWidget", "&导出"))
        self.uiBrowseConfigurationPushButton.setText(_translate("GeneralPreferencesPageWidget", "浏览配置目录"))
        self.uiConfigurationFileLabel.setText(_translate("GeneralPreferencesPageWidget", "未知的路径"))
        self.uiMiscTabWidget.setTabText(self.uiMiscTabWidget.indexOf(self.uiGeneralTab), _translate("GeneralPreferencesPageWidget", "通用"))
        self.uiTelnetConsoleSettingsGroupBox.setTitle(_translate("GeneralPreferencesPageWidget", "控制台设置"))
        self.uiTelnetConsoleCommandLabel.setText(_translate("GeneralPreferencesPageWidget", "用于Telnet的控制台应用程序命令："))
        ...
        self.uiTelnetConsolePreconfiguredCommandPushButton.setText(_translate("GeneralPreferencesPageWidget", "&编辑"))
        self.uiSerialConsoleCommandLabel.setText(_translate("GeneralPreferencesPageWidget", "用于Serial的控制台应用程序命令："))
        ...
        self.uiSerialConsolePreconfiguredCommandPushButton.setText(_translate("GeneralPreferencesPageWidget", "&编辑"))
        self.uiConsoleMiscGroupBox.setTitle(_translate("GeneralPreferencesPageWidget", "其他参数"))
        self.uiCloseConsoleWindowsOnDeleteCheckBox.setText(_translate("GeneralPreferencesPageWidget", "删除某个节点时关闭任何连接的控制台窗口"))
        ...
        self.uiBringConsoleWindowToFrontCheckBox.setText(_translate("GeneralPreferencesPageWidget", "将控制台窗口放到前面（实验特性）"))
        self.uiSlowConsoleAllLabel.setText(_translate("GeneralPreferencesPageWidget", "各个Console运行之间的延时（连接所有设备时）"))
        self.uiDelayConsoleAllSpinBox.setSuffix(_translate("GeneralPreferencesPageWidget", " ms"))
        self.uiMiscTabWidget.setTabText(self.uiMiscTabWidget.indexOf(self.uiConsoleTab), _translate("GeneralPreferencesPageWidget", "控制台应用程序"))
        self.uiVNCConsoleSettingsGroupBox.setTitle(_translate("GeneralPreferencesPageWidget", "虚拟网络计算机连接设置"))
        self.uiVNCConsoleCommandLabel.setText(_translate("GeneralPreferencesPageWidget", "用于VNC的控制台应用程序命令："))
        ...
        self.uiVNCConsolePreconfiguredCommandPushButton.setText(_translate("GeneralPreferencesPageWidget", "&编辑"))
        self.uiMiscTabWidget.setTabText(self.uiMiscTabWidget.indexOf(self.uiVNCTab), _translate("GeneralPreferencesPageWidget", "VNC"))
        self.uiSceneWidthLabel.setText(_translate("GeneralPreferencesPageWidget", "默认宽度："))
        self.uiSceneHeightLabel.setText(_translate("GeneralPreferencesPageWidget", "默认高度："))
        self.uiRectangleSelectedItemCheckBox.setText(_translate("GeneralPreferencesPageWidget", "绘制矩形"))
        self.uiDrawLinkStatusPointsCheckBox.setText(_translate("GeneralPreferencesPageWidget", "绘制链接状态点"))
        self.uiLinkManualModeCheckBox.setText(_translate("GeneralPreferencesPageWidget", "当连接设备时总是使用手动连接的方式"))
        self.uiLabelPreviewLabel.setText(_translate("GeneralPreferencesPageWidget", "默认的标签样式："))
        self.uiDefaultLabelStylePlainTextEdit.setPlainText(_translate("GeneralPreferencesPageWidget", "AaBbYyZz"))
        self.uiDefaultLabelFontPushButton.setText(_translate("GeneralPreferencesPageWidget", "选择默认字体"))
        self.uiDefaultLabelColorPushButton.setText(_translate("GeneralPreferencesPageWidget", "选择默认颜色"))
        ...
        self.uiMiscTabWidget.setTabText(self.uiMiscTabWidget.indexOf(self.uiSceneTab), _translate("GeneralPreferencesPageWidget", "拓扑视图"))
        self.uiLaunchNewProjectDialogCheckBox.setText(_translate("GeneralPreferencesPageWidget", "在应用程序启动时请求配置文件设置"))
        self.uiAutoScreenshotCheckBox.setText(_translate("GeneralPreferencesPageWidget", "当保存项目时进行项目截图"))
        self.uiCheckForUpdateCheckBox.setText(_translate("GeneralPreferencesPageWidget", "自动检查更新"))
        self.uiCrashReportCheckBox.setText(_translate("GeneralPreferencesPageWidget", "发送匿名的使用崩溃数据"))
        self.uiStatsCheckBox.setText(_translate("GeneralPreferencesPageWidget", "发送匿名的使用统计数据"))
        self.uiExperimentalFeaturesCheckBox.setText(_translate("GeneralPreferencesPageWidget", "启用实验特性（危险、重启、请求）"))
        self.uiSlowStartAllLabel.setText(_translate("GeneralPreferencesPageWidget", "各个设备间得延时（开启所有设备时）"))
        self.uiSlowStartAllSpinBox.setSuffix(_translate("GeneralPreferencesPageWidget", " seconds"))
        self.uiMiscTabWidget.setTabText(self.uiMiscTabWidget.indexOf(self.tab), _translate("GeneralPreferencesPageWidget", "其他参数"))
        self.uiRestoreDefaultsPushButton.setText(_translate("GeneralPreferencesPageWidget", "恢复默认设置"))
